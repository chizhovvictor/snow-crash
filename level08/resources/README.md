...
This means that if level08 opens a file, it is read with flag08 permissions.
...
ltrace — это утилита в Linux, которая позволяет отслеживать вызовы функций библиотек (динамических библиотек) во время работы программы
...
создаем ссылку с другим названием, потому что у нас идет проверка на название файла и применяем ее в качестве токена
